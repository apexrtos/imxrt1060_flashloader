...
#define HOST_ENABLE_DDR_MODE(base, flag) (USDHC_EnableDDRMode(base, flag, 0U))
...
/* sd card power */
#define HOST_INIT_SD_POWER(base) BOARD_USDHC_SDCARD_POWER_CONTROL_INIT(base)
#define HOST_ENABLE_SD_POWER(base, enable) BOARD_USDHC_SDCARD_POWER_CONTROL(base, enable)
/* mmc card power */
#define HOST_INIT_MMC_POWER(base) BOARD_USDHC_MMCCARD_POWER_CONTROL_INIT(base)
#define HOST_ENABLE_MMC_POWER(base, enable) BOARD_USDHC_MMCCARD_POWER_CONTROL(base, enable)
/* sd card vselect */
#define HOST_INIT_SD_VSEL(base) BOARD_USDHC_SDCARD_VSELECT_INIT(base)
/* mmc card vselect */
#define HOST_INIT_MMC_VSEL(base) BOARD_USDHC_MMCCARD_VSELECT_INIT(base)
/* sd card detect */
